...
public:
    ...
    // RFC-0165: Optional call dedup window setter fn. When set,
    ...
    // RFC-0167: Optional settings snapshot fn. When set, /settings calls this
    ...
    // RFC-0169: Optional GMT offset setter fn. When set, /setgmtoffset <hours>
